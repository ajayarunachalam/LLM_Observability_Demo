...
Aim: This is a simple end-to-end example
      which showcases how to build a Chatbot with Ollama, Gradio, and Langfuse for LLM Observability and Evaluation.
'''
import ollama
import uuid
...
async def create_response(prompt: str, history):
    ...
    langfuse_context.update_current_trace(
        name="gradio_demo_chat_application",
...
with gr.Blocks() as demo:
    gr.Markdown("# Chatbot using Ollama + Gradio + Langfuse")
    chatbot = gr.Chatbot(
        label="Chat",
        type="messages",
